<template>
    <q-page padding class="documentation-page">
        ...
        >
            ...
            💡 Las props son de solo lectura. Si necesitas modificarlas, usa v-model o emite eventos con defineEmits().
            </p>
        </q-alert>
        </div>
    </q-page>
...
`<script setup>
// Forma simple
defineProps(['titulo', 'activo'])

// Forma avanzada (recomendada)
defineProps({
    titulo: {
        type: String,
        required: true
